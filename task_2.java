...
public void checkIsAdultWhenAgeIsLessThan18False() {
    ...
    assertEquals("Expected the user to be not adult when the age is less than 18", false, isAdult);
}
...
public void checkIsAdultWhenAgeIs18True() {
    ...
    assertEquals("Expected the user to be adult when the age is exactly 18", true, isAdult);
}
